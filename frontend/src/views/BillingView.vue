  ...
  <div>
    ...
    <div id="billing">
      <div class="container">
        ...
        <div class="add-bill">
          <button class="toggleBillingForm" @click="toggleBillingForm = true">
            Generar Factura
          </button>
        </div>
      </div>
      <billing-form
        class="billing-form"
        v-if="toggleBillingForm"
        @close-form="closeBillingForm"
      />
      <single-bill
        class="single-bill"
        v-if="toggleSingleBill"
        @close-single-bill="closeSingleBill"
        :bill="bill"
      />
    </div>
  </div>
